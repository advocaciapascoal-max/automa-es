"""
=============================================================================
  SQUAD OPERACIONAL - PASCOAL ADVOCACIA
=============================================================================
  ...
  Uso:
    cd "AUTOMACOES PASCOAL" && python OPERACIONAL/main.py tarefas
    cd "AUTOMACOES PASCOAL" && python OPERACIONAL/main.py processos
    cd "AUTOMACOES PASCOAL" && python OPERACIONAL/main.py prazos
    cd "AUTOMACOES PASCOAL" && python OPERACIONAL/main.py gerar-peca <lawsuit_id>
    cd "AUTOMACOES PASCOAL" && python OPERACIONAL/main.py gerar-peticao "C:\\pasta_do_cliente"
...
def _headers():
    ...
    return {
        ...
        'User-Agent': 'PASCOAL-Advocacia/1.0',
    }
...
def cmd_tarefas(args):
    print('=' * 80)
    print('  TAREFAS PENDENTES - PASCOAL ADVOCACIA')
    print('=' * 80)
...
def cmd_processos(args):
    print('=' * 80)
    print('  PROCESSOS ATIVOS - PASCOAL ADVOCACIA')
    print('=' * 80)
...
def main():
    parser = argparse.ArgumentParser(description='Squad Operacional - Pascoal & Dyandra Advocacia')

"""
=============================================================================
  PROTOCOLO DE ENTREGA E RECEBIMENTO DE DOCUMENTOS - PASCOAL ADVOCACIA
=============================================================================
...
# ============================================================
ESCRITORIO = {
    'nome': os.getenv('ESCRITORIO_NOME', 'PASCOAL ADVOCACIA'),
    'advogada': os.getenv('ESCRITORIO_ADVOGADO', 'Dr. Alexandre Pascoal Marques'),
    'oab': os.getenv('ESCRITORIO_OAB', 'OAB/SP 270.924'),
    'endereco': os.getenv('ESCRITORIO_CIDADE', 'Sorocaba/SP'),
}
...
def executar_protocolo(args):
    ...
    print('\n' + '=' * 70)
    print('  PROTOCOLO DE ENTREGA/RECEBIMENTO - PASCOAL ADVOCACIA')
    print('=' * 70)
...
def main():
    parser = argparse.ArgumentParser(
        description='Protocolo de Entrega/Recebimento de Documentos - Pascoal & Dyandra Advocacia'
    )

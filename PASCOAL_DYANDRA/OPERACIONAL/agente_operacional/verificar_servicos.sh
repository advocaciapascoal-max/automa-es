#!/bin/bash
# =============================================================
#  VERIFICACAO DOS SERVICOS (macOS/Linux) - AGENTE OPERACIONAL (PASCOAL.IA)
#  Equivalente ao verificar_servicos.bat (Windows).
# =============================================================

echo ""
echo "============================================================"
echo "  VERIFICACAO DOS SERVICOS - AGENTE OPERACIONAL (PASCOAL.IA)"
echo "  $(date)"
echo "============================================================"
echo ""

echo "[1/4] AGENTE OPERACIONAL (porta 8787)..."
if curl -s -m 3 http://localhost:8787/healthcheck > /tmp/_pascoal_health.json 2>/dev/null; then
  echo "      OK    -> $(cat /tmp/_pascoal_health.json)"
else

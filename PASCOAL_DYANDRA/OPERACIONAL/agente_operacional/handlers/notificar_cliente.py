"""
Handler de notificacao de cliente pelo CRM de atendimento (WhatsApp).
...
Usa 100% INTEGRACOES/crm.py (o provedor sai de CRM_PROVIDER no .env).
"""
import re
import sys
import logging
...
def executar(tipo_tarefa: str, instrucao: str, contexto: dict) -> dict:
    ...
    if not contato:
        return {
            ...
            'resumo': (
                f'Telefone {telefone} nao localizado no CRM ({NOME_PROVEDOR}).\n'

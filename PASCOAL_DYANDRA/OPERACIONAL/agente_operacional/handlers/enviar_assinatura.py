...
# A assinatura e um bloco multilinha (um advogado por linha); o responsavel e o
# primeiro da lista, antes da OAB.
RESPONSAVEL_NOME = (
    ESCRITORIO_ASSINATURA.strip().splitlines()[0].split('-')[0].strip()
    if ESCRITORIO_ASSINATURA.strip() else ''
) or 'Advogado Responsavel'

"""Constantes e configuracao do Agente Operacional - Pascoal & Dyandra Advocacia.
...
# ADVBOX
# ============================================================
# ID do usuario-agente (PASCOAL.IA) no ADVBOX - a conta a quem as tarefas sao atribuidas.
...
# referenciando a tarefa original (ex: "[PASCOALIA-FEITO #12345]"), NAO refaz o trabalho.
...
MARCADOR_CONCLUSAO = 'PASCOALIA-FEITO'
...
# Assinatura padrao das pecas geradas: bloco com os advogados que assinam as
# pecas protocoladas do escritorio, um por linha (mesma ordem do padrao usado
# nas pecas). No .env, separe as linhas com \n literal.
ESCRITORIO_ASSINATURA = os.getenv(
    'ESCRITORIO_ASSINATURA',
    'Alexandre Pascoal Marques - OAB/SP 270.924\n'

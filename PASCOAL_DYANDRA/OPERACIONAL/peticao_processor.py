...
Usa a PASCOAL.IA (Claude) para analisar documentos e gerar a peca completa.
"""
import anthropic
import json
import os
...
# ============================================================
# DADOS DO ESCRITORIO (lidos do ambiente, com defaults PASCOAL)
# ============================================================
ESCRITORIO_NOME = os.getenv('ESCRITORIO_NOME', 'Pascoal & Dyandra Advocacia')
ESCRITORIO_ADVOGADO = os.getenv('ESCRITORIO_ADVOGADO', 'Dr. Alexandre Pascoal Marques')
ESCRITORIO_OAB = os.getenv('ESCRITORIO_OAB', 'OAB/SP 270.924')
ESCRITORIO_CIDADE = os.getenv('ESCRITORIO_CIDADE', 'Sorocaba/SP')
...
def gerar_peticao_inicial(classificado: dict) -> dict:
    ...
    print(f"  Contexto: {chars_usados:,} caracteres enviados para a PASCOAL.IA")
    ...
    system_prompt = f'''Voce e PASCOAL.IA, advogada senior com 20 anos de experiencia pratica em direito processual trabalhista, e trabalha em conjunto com o(a) advogado(a) responsavel do {ESCRITORIO_NOME}, {ESCRITORIO_ADVOGADO}, inscrito(a) na {ESCRITORIO_OAB}. Voces formam um time vitorioso.
...
RETORNE APENAS O JSON. Nao inclua texto, introducoes ou blocos ```json markdown.'''
    ...
    print("  Enviando documentos para analise da PASCOAL.IA (Claude)...")

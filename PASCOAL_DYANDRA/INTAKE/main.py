...
from crm import enviar_mensagem_contratacao
...
def run_intake(pdf_path: str, docs_extras: list = None):
    ...
    # 9. Enviar mensagem ao cliente via CRM de atendimento (WhatsApp)
    telefone = dados_extraidos.get("telefone", "")
    if telefone and links:
        print("\n9. Enviando mensagem ao cliente via CRM (WhatsApp)...")

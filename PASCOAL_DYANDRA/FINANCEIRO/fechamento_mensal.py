"""
=============================================================================
  FECHAMENTO MENSAL COMPLETO - PASCOAL ADVOCACIA
=============================================================================
...
def banner(nome_mes, ano, start_date, end_date):
    print('\n')
    print('=' * 70)
    print('   PASCOAL ADVOCACIA - FECHAMENTO MENSAL COMPLETO')
...
def main():
    parser = argparse.ArgumentParser(description='Fechamento Mensal Completo - Pascoal & Dyandra Advocacia')
